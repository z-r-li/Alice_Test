...
> **说明：** 由于我们不受 Token 数量限制，可使用 LLM 实现：
> - 动态生成搜索源列表
> - 操作爬虫程序
> - Agent 浏览功能

默认可信数据源应配置为投行领域的"优质权威机构"（涵盖中英文来源）。
